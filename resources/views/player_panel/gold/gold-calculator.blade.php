                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="input-group" id="dynamic_field">
                                        ...
                                        <INPUT class="form-control-sm" type="text" placeholder="ضریب">
                                ...
                                <div class="card-footer">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="درصد fee">
                                        <span style="margin-left: 10px"></span>
                                        <input type="text" class="form-control" placeholder="درصد gold collector">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="input-group" id="dynamic_field1">
                                        ...
                                        <INPUT class="form-control-sm" type="text" placeholder="مقدار گلد">
                            ...
                            <div class="card mt-3">
                                <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <tr>
                                            <th scope="row">درصد fee</th>
                                            <td>3%</td>
                                            <td style="font-weight: bold">درصد gold collector:</td>
                                            <td>10%</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">مقدار fee</th>
                                            <td>3.8</td>
                                            <td style="font-weight: bold">مقدار gold collector</td>
                                            <td>12</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">مقدار تقسیم شده بدون کسر gold collector</th>
                                            <td>3.8</td>
                                            <td style="font-weight: bold">مقدار تقسیم شده با کسر gold collector</td>
                                            <td>12</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="card-footer">
                                    <div class="input-group">
                                        <button type="button" class="btn btn-success">محاسبه گلد</button>
                                        <span style="margin-left: 10px"></span>

                                        <button type="button" class="btn btn-primary">کپی از جدول</button>
