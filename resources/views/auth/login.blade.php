                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input align-middle" name="remember" type="checkbox" value="" id="remember-check">
                                                <label class="form-check-label" for="remember-check">به یاد داشته باشید </label>
                                            </div>
                                        </div>
                                        @if (Route::has('password.request'))
                                        <a href="route('password.request')" class="text-dark h6 mb-0">رمز عبور را فراموش کرده اید؟</a>
                                    </div>
                                    @endif
                                </div>
