                ...
                <div class="col-6 mt-3">
                    ...
                    <form action="{{route('player.store')}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInput" name="player_name" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInput7" class="form-label">نام کاربری</label>
                            <input type="text" class="form-control" id="exampleInput7" name="user_name" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInput9" class="form-label">رمز عبور</label>
                            <input type="password" class="form-control" id="exampleInput9" name="password" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="relam_id">
                             @foreach($relam as $r)
                                <option value="{{$r->id}}">{{$r->relam_name}}</option>
                                @endforeach
                            </select>
                        </div>
