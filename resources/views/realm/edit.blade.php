...
<head>
    <meta charset="utf-8">
    <title> ویکسانا-ویرایش ریلیم </title>
        ...
        <div class="container-fluid">
            <div class="layout-specing">
                ...
                <div class="col-6 mt-3">
                    ...
                    <form action="{{route('realm.update',$r->id)}}" method="post">
                        @csrf
                        @method('put')
                        <div class="mb-3">
                            <label for="exampleInput" class="form-label">نام ریلیم</label>
                            <input type="text" class="form-control" id="exampleInput" name="relam_name" value="{{$r->relam_name}}" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">آدرس ریلیم</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="relam_address" value="{{$r->relam_address}}" required>
                        </div>
