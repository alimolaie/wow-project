        ...
        <div class="container-fluid">
            <div class="layout-specing">
                ...
                <div class="col-6 mt-3">
                        ...
                        <form action="{{route('realm.store')}}" method="post">
                            @csrf
                            <div class="mb-3">
                                <label for="exampleInput" class="form-label">نام ریلیم</label>
                                <input type="text" class="form-control" id="exampleInput" name="relam_name" required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">آدرس ریلیم</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="relam_address" required>
                            </div>
